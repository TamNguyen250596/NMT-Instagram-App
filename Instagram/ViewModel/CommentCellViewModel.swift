...
struct CommentCellViewModel {
    ...
    func attributedTitle() -> NSMutableAttributedString {
        ...
        let attributedTitle = NSMutableAttributedString(string: comment.userName + "  ", attributes: attrLine1)
        
        let attrLine2: [NSAttributedString.Key: Any] = [.foregroundColor: UIColor.darkGray, .font: UIFont.boldSystemFont(ofSize: 14)]
        attributedTitle.append(NSAttributedString(string: comment.commentTxt, attributes: attrLine2))
